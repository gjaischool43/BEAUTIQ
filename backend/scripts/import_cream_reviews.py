# scripts/import_cream_review.py
...
# ============================================
BASE_CSV_PATH = r"C:\Users\rumbl\OneDrive\바탕 화면\인공지능사관학교\기업 프로젝트\설계\beautiq\backend\scripts\1122_cream.csv"
...
def clean_record(rec: dict, default_category: str = "cream") -> dict:
    """
...
def import_csv_to_db(
    ...
    default_category: str = "cream",
    chunk_size: int = CHUNK_SIZE,
):
    """
    1122_cream.csv 를 oliveyoung_review 테이블에 적재하는 함수.
    """
...
if __name__ == "__main__":
    """
    사용법:
      📌 기본 (1122_cream.csv 사용)
        python scripts/import_cream_review.py

      📌 다른 CSV 경로로 실행하고 싶다면:
        python scripts/import_cream_review.py path/to/other.csv
    """
    if len(sys.argv) == 1:
        ...
        print("Usage: python scripts/import_cream_review.py [csv_path]")
        sys.exit(1)

    import_csv_to_db(base_csv_path=base_path, default_category="cream")
