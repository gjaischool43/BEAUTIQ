...
export function SidebarTrigger({
    ...
    return (
        <Button
            variant="ghost"
            size="icon"
            className={["size-7", className].join(" ")}
            onClick={(e) => {
                onClick?.(e);
                toggleSidebar();
            }}
...
export function SidebarInset({
    ...
    return (
        <main
            ...
            className={["relative flex w-full flex-1 flex-col", className].join(" ")}
            {...props}
        />
    );
}
...
export function SidebarHeader({
    ...
    return (
        <div
            ...
            className={["flex flex-col gap-2 p-2", className].join(" ")}
            {...props}
        />
    );
}
...
export function SidebarSeparator({
    ...
    return (
        <Separator
            className={["mx-2 w-auto", className].join(" ")}
            {...props}
        />
    );
}
...
export function SidebarContent({
    ...
    return (
        <div
            ...
            className={["flex min-h-0 flex-1 flex-col gap-2 overflow-auto", className].join(" ")}
            {...props}
        />
    );
}
...
export function SidebarInput({
    ...
    return (
        <Input className={["h-8 w-full shadow-none", className].join(" ")} {...props} />
    );
}
...
export function SidebarGroup({
    ...
    return (
        <div
            ...
            className={["relative flex w-full min-w-0 flex-col p-2", className].join(" ")}
            {...props}
        />
    );
}
...
const sidebarMenuButtonVariants = cva(
    "flex w-full items-center gap-2 rounded-md p-2 text-left text-sm transition-colors hover:bg-accent hover:text-accent-foreground [&>svg]:size-4",
    {
        variants: {
...
export function SidebarMenuButton({
    ...
    const button = (
        <Comp
            ...
            className={[sidebarMenuButtonVariants({ variant, size }), className].join(" ")}
            {...props}
        />
    );
    ...
    return (
        <Tooltip>
            ...
            <TooltipContent side="right" align="center" {...tipProps} />
        </Tooltip>
    );
}
...
export function SidebarMenu({
    ...
    return (
        <ul
            className={["flex w-full min-w-0 flex-col gap-1", className].join(" ")}
            {...props}
        />
    );
}
...
export function SidebarMenuItem({
    ...
    return (
        <li className={["group relative", className].join(" ")} {...props} />
    );
}
...
export function SidebarMenuSubItem({
    ...
    return <li className={["relative", className].join(" ")} {...props} />;
}
