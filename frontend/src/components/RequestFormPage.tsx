                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={(value: string) => setFormData({ ...formData, platform: value as Platform })}
                                >
                            ...
                            <div className="space-y-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={(value: string) => setFormData({ ...formData, productCategory: value as CategoryCode })}
                                >
